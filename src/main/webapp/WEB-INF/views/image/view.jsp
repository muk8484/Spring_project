...
<!-- <script type="text/javascript" src = "/js/frontReply.js"></script> -->
	...
	<div class="container">
		...
		<div class="well">
			...
			<div class="row">
				<div class="col-md-3">
					이미지
					<a href="${vo.fileName }" class="btn btn-danger" download >다운로드</a>
					<!-- 이미지 바꾸기 : form 태그가 있는 모달창을 사용해서 post방식으로 변경 a 태그는 get방식 전달을 하므로 이미지 전달이 안된다.-->
<%-- 					<a href="change.do?no=${vo.no }&deleteFile=&{vo.fileName}" class="btn btn-primary" download >사진 수정</a> --%>
					<c:if test="${!empty login }">
						<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#updateModal">이미지 바꾸기</button>
					</c:if>
				</div>
				<div class="col-md-9"><img class="img-thumbnail" src="${vo.fileName }"></div>
			</div>
			<div class="row">
...
<!-- 							</li> -->
	...
	<div id="updateModal" class="modal fade" role="dialog">
	  <div class="modal-dialog">
		...
		<!-- 숨겨서 넘겨 줘야할 데이터 - 페이지, 한 페이지당 갯수, 삭제해야할 기존 파일 -->
		    ...
		    <div class="modal-content">
		      ...
		      <div class="modal-body">
		        <div class="form-group">
					...
					<input name="no" id="no" type="text" value="${vo.no }" class="form-control" 
					readonly="readonly" onclick="alert('번호는 변경할수 없습니다.');">
				</div>
		        <div class="form-group">
					<label for="imageFile">이미지 파일</label> 
					<input name="imageFile" id="imageFile" type="file" class="form-control" required="required">
				</div>
		      </div>
